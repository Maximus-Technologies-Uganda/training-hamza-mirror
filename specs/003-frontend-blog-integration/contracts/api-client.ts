...
import type { Post, CreatePostInput, UpdatePostInput, HealthStatus, ApiError } from '../types';
 ...
 * @throws ApiError for API errors (500, etc.)
 * @throws Error for network failures
 * 
 * @example
 ...
 * @returns Post object
 * @throws ApiError with status 404 if post not found
 ...
 * @throws ApiError for other API errors (500, etc.)
 * @throws Error for network failures
 * 
 * Validation rules:
